    ...
    <>
      ...
      <CenteredView>
        ...
        <Info
          ...
          padding="15px"
        >
          <ThemedText type="long-paragraph">
            *Asegurese de contar con la presencia de cámara y micrófono a la
