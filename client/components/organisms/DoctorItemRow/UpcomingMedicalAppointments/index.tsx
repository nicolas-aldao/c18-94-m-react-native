...
interface UpcomingMedicalAppointmentsProps {
    image_url: any;
    name: string;
    specialty: string;
    date: string;
...
export const UpcomingMedicalAppointments: FC<UpcomingMedicalAppointmentsProps> = ({ image_url, name, specialty, date, time }) => {
